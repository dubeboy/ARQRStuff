...
struct DVTGrad {
	...
	init?(data: [String: Any]?) {
		...
		guard id != -1, gradPrograme != "N/A", gradsInProgram != "N/A", mascotName != "N/A" else { return nil }
		self.init(id: id, gradPrograme: gradPrograme, gradsInProgram: gradsInProgram, mascotName: mascotName)
	}
}
